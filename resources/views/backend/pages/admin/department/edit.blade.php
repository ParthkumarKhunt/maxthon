                ...
                <form class="form" id="add-department-form" method="POST">@csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group ">
                            <label class="col-form-label ">Department Name (Ex : Web Design , App Development)
                            <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Please enter department name" value="{{  $details[0]->name }}" />
                        </div>
                    </div>
