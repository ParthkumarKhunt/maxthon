...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item {{ ( $currentRoute == 'admin-dashboard'  ? 'menu-item-active' : '' )  }}" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-submenu {{ ( $currentRoute == 'admin-portfolio-category-add' || $currentRoute == 'admin-portfolio-category' || $currentRoute == 'admin-portfolio-category-edit' || $currentRoute == 'admin-galleryimage-add' || $currentRoute == 'admin-galleryimage' || $currentRoute == 'admin-galleryimage-edit' ? 'menu-item-active menu-item-open' : '' )  }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-11-19-154210/theme/html/demo1/dist/../src/media/svg/icons/Communication/Group-chat.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <polygon points="0 0 24 0 24 24 0 24"/>
                ...
                <li class="menu-item menu-item-submenu {{ ( $currentRoute == 'admin-contactus-details' || $currentRoute == 'admin-contactus-list'  ? 'menu-item-active menu-item-open' : '' )  }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-11-19-154210/theme/html/demo1/dist/../src/media/svg/icons/Communication/Group-chat.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            <li class="menu-item {{ ( $currentRoute == 'admin-contactus-details'  ? 'menu-item-active ' : '' )  }}" aria-haspopup="true">
                                <a href="{{ route('admin-contactus-details') }}" class="menu-link">

                                    <span class="menu-text"><i class="far fa-hand-point-right" style="color: white"></i>&nbsp;&nbsp;Details</span>
                                </a>
                            </li>
                ...
                <li class="menu-item {{ ( $currentRoute == 'admin-testimonials-add' || $currentRoute == 'admin-testimonials' || $currentRoute == 'admin-testimonials-edit'  ? 'menu-item-active' : '' )  }}" aria-haspopup="true">
                ...
                <li class="menu-item  {{ ( $currentRoute == 'admin-service-add' || $currentRoute == 'admin-service' || $currentRoute == 'admin-service-edit' ? 'menu-item-active ' : '' )  }}" aria-haspopup="true">
